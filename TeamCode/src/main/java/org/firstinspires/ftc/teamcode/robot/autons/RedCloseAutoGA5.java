...
@Autonomous(name = "Red Close - GA 5")
public class RedCloseAutoGA5 extends OpMode {
    ...
    private final Pose closeStart = Poses.Red.closeStart;

    private final Pose closeScore = Poses.Red.closeScore;
    private final Pose lineUpSpike2 = Poses.Red.lineUpSpike2;
    private final Pose pickUpSpike2 = Poses.Red.pickUpSpike2;
    private final Pose openGate = Poses.Red.openGate;
    private final Pose exitGate = Poses.Red.exitGate;
    private final Pose lineUpSpike1 = Poses.Red.lineUpSpike1;
    private final Pose pickUpSpike1 = Poses.Red.pickUpSpike1;
    private final Pose lineUpSpike3 = Poses.Red.lineUpSpike3;
    private final Pose pickUpSpike3 = Poses.Red.pickUpSpike3;
    private final Pose exitSpike3 = Poses.Red.exitSpike3;
    private final Pose closeScorePark = Poses.Red.closeScorePark;
